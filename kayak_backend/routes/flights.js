...
router.post('/searchflights', function(req, res, next) {
    ...
    flightServices.searchFlights(details, function(err,result){
        if(err){
            console.log(err);
        }else {
...
router.post('/bookflight', function(req, res, next) {
    ...
    flightServices.bookFlight(flightbookingdetail, function(err,result){
        if(err){
...
router.post('/addflight', function(req, res, next) {
    ...
    flightServices.addFlight(flightDetail, function(err,result){
        if(err){
...
router.post('/deleteflight', function(req, res, next) {
    ...
    flightServices.deleteFlight(flightDetail, function(err,result){
        if(err){
...
router.post('/editflight', function(req, res, next) {
    ...
    flightServices.editFlight(flightDetail, function(err,result){
        if(err){
