...
router.post('/searchcars', function(req, res, next) {
    ...
    carServices.searchCars({"src_city" : src_city , "destination_city" : destination_city,user_id:user_id}, function(err,result){
        if(err){
...
router.post('/addcar', function(req, res, next) {
    ...
    carServices.addCar(cardetail, function(err,result){
        if(err){
...
router.post('/bookcar', function(req, res, next) {
    ...
    carServices.bookCar(carbookingdetail, function(err,result){
        if(err){
...
router.post('/deletecar', function(req, res, next) {
    ...
    carServices.deleteCar(cardetail, function(err,result){
        if(err){
...
router.post('/editcar', function(req, res, next) {
    ...
    carServices.editCar(cardetail, function(err,result){
        if(err){
